...
<body>
	...
	<div	 >
		<form >
			<div class="row">
				...
				<br/>
				<div class="btn-group">
				    <button type="button" class="btn btn-default"  onclick="addOrganization()">新增组织</button>
				</div>
	...
	<script type="text/javascript" src="${base}/resources/develop/js/organization/organizationList.js"></script>
</body>
</html>