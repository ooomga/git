...
<body>
	...
	<div	 >
		<form >
			<div class="row">
				...
				<br/>
				<div class="btn-group">
				    <button type="button" class="btn btn-default"  onclick="addPermission()">新增权限</button>
				</div>
	...
	<script type="text/javascript" src="${base}/resources/develop/js/permission/permissionList.js"></script>
</body>
</html>