...
<body>
	...
	<div	 >
		<form >
			<div class="row">
				...
				<br/>
				<div class="btn-group">
				    <button type="button" class="btn btn-default"  onclick="addSystemUser()">新增系统用户</button>
				</div>
	...
	<script type="text/javascript" src="${base}/resources/develop/js/systemuser/systemUserList.js"></script>
</body>
</html>