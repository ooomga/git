...
<body>
	<!-- 占位符 end -->
	<div>
		<form  id="modifyLineForm">
			<br>
			<div class="input-group"  >
				<span class="input-group-addon">线路编码</span>
				<input type="text"	id="lineCode" name="lineCode" class="form-control" disabled="disabled" value="${data.list[0].lineCode}">
				<input type="hidden"	id="seq" name="seq"	class="form-control"  value="${data.list[0].seq}">
			</div>
			<br>
			<div class="input-group">
				<span class="input-group-addon">线路名称</span> 
				<input type="text" id="lineName" name="lineName" class="form-control"  value="${data.list[0].lineName}">
			</div>
			<br>
			<div class="input-group">
				<span class="input-group-addon">英文名称</span> 
				<input type="text"	id="lineEName" name="lineEName"	class="form-control" value="${data.list[0].lineEName}">
			</div>
			<br>
			<div class="form-group">
				<div class="col-sm-offset-3 col-sm-10">
					<button type="button" onclick="update()" class="btn btn-default">保存</button>
