		...
		<form >
			<div class="row">
				...
				<div class="btn-group"  style="margin-left:10px;">
				    <button type="button" class="btn btn-default"  onclick="addRichText()">新增资讯</button>
				</div>
...
<%-- <script type="text/javascript" src="${base}/resources/plugIn/layer/layer.js"></script> --%>
	...
	<script type="text/javascript" src="${base}/resources/develop/js/richtext/richtextList.js"></script>
</body>
</html>