...
<body>
	...
	<div>
		<form  id="addLostForm">
			...
			<br>
			<div class="input-group">
				<span class="input-group-addon">选取物品图片</span> 
				<input type="text" id="image" name="image"	class="form-control" />
				<button type="button" class="btn btn-default  btn-center">选取</button>
			</div>
			<br>
			<div class="input-group" >
				 <span class="input-group-addon">关键信息</span>
				 <input type="text" id="keyInfo"name="keyInfo"	class="form-control" >
			</div>
			<br>
	...
	<script type="text/javascript"
		src="${base}/resources/develop/js/station/addLost.js"></script>
</body>
</html>