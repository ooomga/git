...
<body>
			...
			<div class="row">
				<div class="col-sm-12 mulu-list"  >
					<div class="right_menu">
						<span>车站信息管理&gt;硬件设施管理</span>
					</div>
				</div>
			</div>
			<br/>
				<div class="btn-group" style="margin-left:10px;">
				    <button type="button" class="btn btn-default"  onclick="addHardware()">新增硬件</button>
				</div>
	...
	<script type="text/javascript" src="${base}/resources/develop/js/station/hardware.js"></script>
</body>
</html>