		...
		<form  id="addLineForm">
			...
			<div class="input-group"  >
				<span class="input-group-addon">线路编码</span>
				 <input type="text" id="lineCode"	name="lineCode"	class="form-control" placeholder="必填项">
			</div>
			<br>
			<div class="input-group">
				<span class="input-group-addon">线路名称</span> 
				<input type="text"	id="lineName" name="lineName"	class="form-control" placeholder="必填项">
			</div>
			<br>
			<div class="input-group">
				<span class="input-group-addon">英文名称</span> 
				<input type="text"	id="lineEName" name="lineEName"	class="form-control" placeholder="必填项">
			</div>
			<br>
