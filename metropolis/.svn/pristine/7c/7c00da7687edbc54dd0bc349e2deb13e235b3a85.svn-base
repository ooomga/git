	...
	<div>
		<form  id="addStationWin">
			...
			<div class="input-group">
				...
				<input type="text"	id="stationName" name="stationName"	class="form-control" placeholder="必填项">
			</div>
			<br>
			<div class="input-group">
				<span class="input-group-addon">所属线路</span> 
				<select name="lineCode" id="lineCode" data-placeholder="选择所属线路"  style="width: 200px;height: 38px;">
						<c:if test="${not empty data.list }">
							<c:forEach var="line" items="${data.list }">
			...
			<br>
			<div class="input-group">
				<span class="input-group-addon">关联线路</span> 
				<input type="text"	id="lineCode" name="lineCode"	class="form-control" placeholder="">
			</div>
			<br>
			<div class="form-group">
				<div class="col-sm-offset-3 col-sm-10">
					<button type="button" onclick="save('add')"   class="btn btn-default">保存</button>
