...
<div >
    <form id="addMessageForm"  action="" method="post">
    	<div>
			标题:<input type="text" id="title"  name="title" placeholder="必填项"  value=""  />
		</div>
		<br/>
		<!-- <div>
			发布人:<input type="text" id="author" name="author" placeholder="必填项" value=""  />
		</div>
		<br/> -->
		<%-- <div>
			类型:
		...
		<div>
			...
			<input type="hidden" id="image"  name="image"   multiple="multiple"    value="" /> 
		</div>
		<br/>
	    <div>
...
<script type="text/javascript" src="${base }/resources/develop/js/message/addMessage.js"></script>
<script type="text/javascript">
