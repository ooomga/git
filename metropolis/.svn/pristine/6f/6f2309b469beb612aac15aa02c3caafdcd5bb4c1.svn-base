...
<body>
	<!-- 占位符 end -->
	<div>
		<form  id="editHardForm">
			<br>
			<div class="input-group"  >
				<span class="input-group-addon">硬件类型</span>
				 <select name="name" style="width: 150px;height: 35px;">
				 	<option value="">请选择</option>
				 	<option value="1" selected>卫生间</option>
			...
			<div class="input-group">
				...
				<input type="text"	id="address" name="address"	class="form-control" value="费区内，列车往莘庄方向">
			</div>
			<br>
			<div>
			...
			<div class="form-group">
				<div class="col-sm-offset-3 col-sm-10">
					<button type="button" onclick="edit()"   class="btn btn-default">保存</button>
