...
<body>
	...
	<div	 >
		<form >
			<div class="row">
				...
				<br/>
				<div class="btn-group">
				    <button type="button" class="btn btn-default"  onclick="addNotice()">信息发送</button>
				</div>
	...
	<script type="text/javascript" src="${base}/resources/develop/js/notice/notice.js"></script>
</body>
</html>