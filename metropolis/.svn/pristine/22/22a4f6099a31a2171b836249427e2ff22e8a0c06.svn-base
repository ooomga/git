...
<body>
	...
	<div>
		<form  id="addPermissionForm">
			...
			<div class="input-group">
				...
				<input type="text"		name="module"	class="form-control" placeholder="请输入模块名称">
			</div>
			<br>
			<div class="input-group">
				<span class="input-group-addon">级别</span>
				 <input type="number"		name="level"	class="form-control"  placeholder="请输入级别">
			</div>
			<br>
			<div class="input-group">
	...
	<script type="text/javascript"
		src="${base}/resources/develop/js/permission/addPermission.js"></script>
</body>
</html>