...
public interface ICommonDao {
	 ...
	 * @return
	 */
	List<Map<String, Object>> select(Map<String, Object> param, String tableName, List<String> selectItems, String orderBy);
	
	/**
	 * 按完整的sql语句查询
	 * <ul>
	 * <li>ZX 2017年1月2日 新建</li>
	 * </ul>
	 * 
	 * @param selectSql
	 * @return
	 */
	List<Map<String, Object>> select(String selectSql, Map<String, Object> param);
}
