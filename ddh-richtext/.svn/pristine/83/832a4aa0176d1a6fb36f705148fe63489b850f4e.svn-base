 ...
 * http://hayageek.com/docs/jquery-upload-file.php#showold
 * http://hayageek.com/
 */
(function($) {
	...
	$.fn.uploadFile = function(options) {
		...
		var s = $.extend({
			...
			dragDropStr : "<span><b>支持文件拖放</b></span>",
			uploadStr : "上传",
			abortStr : "中止",
			cancelStr : "取消",
			deletelStr : "删除",
			doneStr : "完成",
			multiDragErrorStr : "不允许多文件拖放",
			extErrorStr : "只能上传：",
			duplicateErrorStr : "文件已存在",
			sizeErrorStr : "文件最大只能是：",
			uploadErrorStr : "上传失败",
			maxFileCountErrorStr : "最多只能上传文件个数：",
			downloadStr : "下载",
